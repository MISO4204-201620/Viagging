...
public class MessageController {
	...
	public void addMensajeConversacion(@RequestBody MensajeDTO mensajeDTO, @PathVariable Integer idConversacion){
		mensajeDTO.setIdConversacion(idConversacion);
		mensajeService.createMensajeConversacion(mensajeMapper.mapObject(mensajeDTO));
	}
